...
def init_Simulation_Parser():
    ...
    parser.add_argument('-s', '--source', type=str, required=False, default=None, metavar='SOURCE_MIGRATION_POP', help='Source population for migratio; default: no migrationn')
    parser.add_argument('-d', '--dest', type=str, required=False, default=None, metavar='DESTINATION_MIGRATION_POP', help='Destination population for migration; default: no migration')
